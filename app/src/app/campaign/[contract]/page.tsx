          ...
          <Card className="p-3">
            <CardContent className="space-y-3">
              ...
              <Card className="mb-3 text-xs">
                <CardHeader className="p-3 pb-1">
                  <CardTitle className="text-base">
                    Objective: ${totalContribution.toLocaleString()} / $
              ...
              <Card className="mb-3 text-xs">
                ...
                <CardContent className="p-3">
                  ...
                  <p className="text-xs text-gray-600">
                    This amount will be donated in addition to your locked
                    amount.
                  </p>
                </CardContent>
              </Card>
              <Card className="mb-3 text-xs">
                <CardContent className="p-3">
                  <p className="mb-1">
                    Amount Locked: ${amountStacked.toLocaleString()}
                  </p>
                  <p className="mb-1">
                    Lock Duration: {formatDuration(lockDuration)}
                  </p>
                  ...
                  <p className="mb-1">
                    Yield Amount: ${calculateYield().toLocaleString()}
                  </p>
                  <p className="mb-1">
                    Additional Donation: ${donationAmount.toLocaleString()}
                  </p>
                  <p className="font-bold">
                    Total Contribution: ${totalContribution.toLocaleString()}
                  </p>
                </CardContent>
              </Card>
              <Button
                ...
                onClick={() => {
                  ...
                  alert(
                    `Locked: $${amountStacked}, Donated: $${donationAmount}, Total Contribution: $${totalContribution.toLocaleString()}`
                  );
                }}
              >
